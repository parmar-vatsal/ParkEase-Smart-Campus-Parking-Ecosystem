            ...
            <div className="w-full max-w-lg animate-fade-in-up">
                ...
                <div style={{ textAlign: 'center', marginBottom: 32 }}>
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '0.85rem' }}>
                        Register your vehicle for smart campus parking
                    </p>
                </div>
                ...
                {successMessage ? (
                    ...
                    <form onSubmit={handleRegister} className="glass-card" style={{ padding: '28px 24px' }}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <input className="input" style={{ paddingLeft: 36, fontSize: '0.8rem' }} placeholder="ET24BTAI807"
                                        value={form.enrollmentId} onChange={(e) => updateForm('enrollmentId', e.target.value)} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ marginBottom: 24 }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <GraduationCap size={15} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: '#64748b' }} />
                                <input type="number" className="input" style={{ paddingLeft: 36, fontSize: '0.8rem' }} placeholder="6"
                                    min="1" max="8" value={form.semester} onChange={(e) => updateForm('semester', e.target.value)} required />
                            </div>
                        </div>
